  ...
  <div class="input-post-view">
    <main class="form">
      ...
      <div class="form-input" v-on:submit.prevent>
        ...
        <div class="mb-3">
          <label for="formGroupExampleInput2" class="form-label">Waktu Mulai</label>
          <input
            type="time"
            class="form-control"
            id="formGroupExampleInput2"
        ...
        <div class="mb-3">
          <label for="formGroupExampleInput2" class="form-label">Waktu Selesai</label>
          <input
            type="time"
            class="form-control"
            id="formGroupExampleInput2"
...
export default {
  ...
  methods: {
    ...
    events(e) {
      if (
        ...
        this.$router.push({ path: "/dashboardlembaga/"+this.$route.params.lembagaId });
      } else {
  ...
  mounted() {
    axios
      .get("http://localhost:5000/lembagaid/" + this.$route.params.lembagaId)
